...
const Footer = () => {
    return (
        <div className="bg-[#2A7CC7] md:h-[400px] p-5">
            <footer className=" flex flex-col md:flex-row justify-between  max-w-[1400px] mx-auto p-5 text-base-content ">
                ...
                <div className="text-white flex flex-col mb-5">
                    <header className="text-xl font-bold">Services</header><a className="cursor-pointer">Admissions</a>
                    ...
                    <a className="cursor-pointer">Student Counseling</a>
                    <a className="cursor-pointer">E-learning Platform</a>
                    <a className="cursor-pointer">Online Fee Payment</a>
                    <a className="cursor-pointer">Transportation</a>
                </div>
                <div className="text-white flex flex-col mb-5">
                    <header className="font-bold text-xl">Company</header>
                    <a className="cursor-pointer">About us</a>
                    <a className="cursor-pointer">Contact</a>
                    <a className="cursor-pointer">Jobs</a>
                    <a className="cursor-pointer">Press kit</a>
                    <a className="cursor-pointer">Student Portal</a>
                    <a className="cursor-pointer">Faculty</a>
                    <a className="cursor-pointer">Library</a>
                </div>
                <div className="text-white flex flex-col mb-5">
                    ...
                    <a className="cursor-pointer">Code of Conduct</a>
                    <a className="cursor-pointer">Non-discrimination Policy</a>
                    <a className="cursor-pointer">Data Protection</a>
                </div>

                <nav className="text-white ">
                    <header className="font-bold text-xl">Social</header>
